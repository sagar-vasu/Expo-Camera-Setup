    ...
    render() {
        return (
            <View style={styles.container}>
                    ...
                    <View style={[styles.congrats, { marginLeft: 40, }]}>
                        <View >
                            <Image
                                ...
                                source={require('../../assests/trophy.png')}
                            />
                        </View>
                        <View style={{ flex: 1, marginLeft: 20 }}>
                            <Text style={{ color: 'white', fontSize: 18 }}>Good Work!</Text>
                ...
                <Card sliderValue={33} noSteps={1} />
                </View>
                <ScrollView style={{ flex: 1 }}>
                    <View style={styles.bodyContainer}>
                    <Text style={styles.activityTxt}>SET YOUR ACTIVITIES:</Text>
                    <List route='Home3' props={this.props} name="Complete your medical data" iconName="credit-card" info="Visible to your doctor" />
